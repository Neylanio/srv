...
class LoginsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create login" do
    assert_difference('Login.count') do
      post logins_url, params: { login: { login: @login.login, senha: @login.senha, server_id: @login.server_id, user_id: @login.user_id } }
    end
  ...
  test "should update login" do
    patch login_url(@login), params: { login: { login: @login.login, senha: @login.senha, server_id: @login.server_id, user_id: @login.user_id } }
